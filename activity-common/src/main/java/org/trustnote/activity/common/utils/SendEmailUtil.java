...
public class SendEmailUtil {
    ...
    private static String account="support@trustnote.org";    //登录用户名
    private static String pass="ThingTrust123";        //登录密码
    ...
    public void send(){
        ...
        try {
            //发件人
            mimeMessage.setFrom(new InternetAddress(account,"TrustNote"));        //可以设置发件人的别名
