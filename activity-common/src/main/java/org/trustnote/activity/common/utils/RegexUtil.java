...
public class RegexUtil {
	...
	public static String getDomain(String url) {
		Pattern p = Pattern.compile("(?<=|\\.)[^.]*?\\.(com|cn|net|org|biz|info|cc|tv|edu|io)", Pattern.CASE_INSENSITIVE);
		// 获取完整的域名
	 ...
	 * @param space
	 */
	public static String trimeSpace(String space) {
	 ...
	 * @return 验证成功返回true，验证失败返回false
	 */
	public static boolean checkTTTAdress(String postcode) {
	...
	public static  void main(String args[]){
		String ss="com.thingtrust.baas.common.exception.BusinessException: 账号不存在\n";
